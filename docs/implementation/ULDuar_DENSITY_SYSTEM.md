...
> The `WIP` branch of this repository records `modules/mod-density-test` as a submodule pointer to
> `e94bc3a`, the skeleton commit. The density code is in `347faa7` and later on the module repository.
